...
<?php if ($this->_rootref['S_EDIT_FORUM']) {  ?>
	...
	<div id="forum_post_options">
		...
		<div id="forum_points_options">
			<fieldset>
				<legend><?php echo ((isset($this->_rootref['L_FORUM_POINT_SETTINGS'])) ? $this->_rootref['L_FORUM_POINT_SETTINGS'] : ((isset($user->lang['FORUM_POINT_SETTINGS'])) ? $user->lang['FORUM_POINT_SETTINGS'] : '{ FORUM_POINT_SETTINGS }')); ?></legend>
				<p><?php echo ((isset($this->_rootref['L_FORUM_POINT_SETTINGS_EXPLAIN'])) ? $this->_rootref['L_FORUM_POINT_SETTINGS_EXPLAIN'] : ((isset($user->lang['FORUM_POINT_SETTINGS_EXPLAIN'])) ? $user->lang['FORUM_POINT_SETTINGS_EXPLAIN'] : '{ FORUM_POINT_SETTINGS_EXPLAIN }')); ?></p>
				<dl>
					<dt><label><?php echo ((isset($this->_rootref['L_FORUM_PERTOPIC'])) ? $this->_rootref['L_FORUM_PERTOPIC'] : ((isset($user->lang['FORUM_PERTOPIC'])) ? $user->lang['FORUM_PERTOPIC'] : '{ FORUM_PERTOPIC }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_FORUM_PERTOPIC_EXPLAIN'])) ? $this->_rootref['L_FORUM_PERTOPIC_EXPLAIN'] : ((isset($user->lang['FORUM_PERTOPIC_EXPLAIN'])) ? $user->lang['FORUM_PERTOPIC_EXPLAIN'] : '{ FORUM_PERTOPIC_EXPLAIN }')); ?></span></dt>
					<dd><input type="text" id="forum_pertopic" maxlength="6" size="5" name="forum_pertopic" value="<?php echo (isset($this->_rootref['FORUM_PERTOPIC'])) ? $this->_rootref['FORUM_PERTOPIC'] : ''; ?>" /></dd>
				</dl>
				<dl>
					<dt><label><?php echo ((isset($this->_rootref['L_FORUM_PERPOST'])) ? $this->_rootref['L_FORUM_PERPOST'] : ((isset($user->lang['FORUM_PERPOST'])) ? $user->lang['FORUM_PERPOST'] : '{ FORUM_PERPOST }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_FORUM_PERPOST_EXPLAIN'])) ? $this->_rootref['L_FORUM_PERPOST_EXPLAIN'] : ((isset($user->lang['FORUM_PERPOST_EXPLAIN'])) ? $user->lang['FORUM_PERPOST_EXPLAIN'] : '{ FORUM_PERPOST_EXPLAIN }')); ?></span></dt>
					<dd><input type="text" id="forum_perpost" maxlength="6" size="5" name="forum_perpost" value="<?php echo (isset($this->_rootref['FORUM_PERPOST'])) ? $this->_rootref['FORUM_PERPOST'] : ''; ?>" /></dd>
				</dl>
				<dl>
					<dt><label><?php echo ((isset($this->_rootref['L_FORUM_PEREDIT'])) ? $this->_rootref['L_FORUM_PEREDIT'] : ((isset($user->lang['FORUM_PEREDIT'])) ? $user->lang['FORUM_PEREDIT'] : '{ FORUM_PEREDIT }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_FORUM_PEREDIT_EXPLAIN'])) ? $this->_rootref['L_FORUM_PEREDIT_EXPLAIN'] : ((isset($user->lang['FORUM_PEREDIT_EXPLAIN'])) ? $user->lang['FORUM_PEREDIT_EXPLAIN'] : '{ FORUM_PEREDIT_EXPLAIN }')); ?></span></dt>
					<dd><input type="text" id="forum_peredit" maxlength="6" size="5" name="forum_peredit" value="<?php echo (isset($this->_rootref['FORUM_PEREDIT'])) ? $this->_rootref['FORUM_PEREDIT'] : ''; ?>" /></dd>
				</dl>
				<dl>
					...
					<dd><label><input type="radio" class="radio" name="forum_costs" value="1"<?php if ($this->_rootref['S_FORUM_COSTS']) {  ?> id="forum_costs" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label>
						<label><input type="radio" class="radio" name="forum_costs" value="0"<?php if (! $this->_rootref['S_FORUM_COSTS']) {  ?> id="forum_costs" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label></dd>
				</dl>
			</fieldset>
		</div>
		<!-- End Ultimate Points -->
