...
<div id="pagecontent">
	...
	<tr>
		<td class="row1" align="center">
			...
			<?php } ?><!-- [+] Karma MOD //--><?php if ($this->_rootref['S_KARMA']) {  ?>

				<tr>
					<td align="center"><?php echo ((isset($this->_rootref['L_KARMA'])) ? $this->_rootref['L_KARMA'] : ((isset($user->lang['KARMA'])) ? $user->lang['KARMA'] : '{ KARMA }')); ?>:</td>
					<td align="center">
						<?php echo (isset($this->_rootref['KARMA'])) ? $this->_rootref['KARMA'] : ''; ?>

						<?php if ($this->_rootref['U_KARMA_COMMENTS']) {  ?>

							 | <strong><a href="<?php echo (isset($this->_rootref['U_KARMA_COMMENTS'])) ? $this->_rootref['U_KARMA_COMMENTS'] : ''; ?>"><?php echo ((isset($this->_rootref['L_KARMA_USER_COMMENTS'])) ? $this->_rootref['L_KARMA_USER_COMMENTS'] : ((isset($user->lang['KARMA_USER_COMMENTS'])) ? $user->lang['KARMA_USER_COMMENTS'] : '{ KARMA_USER_COMMENTS }')); ?></a></strong>
						<?php } if ($this->_rootref['U_KARMA_INCREASE'] || $this->_rootref['U_KARMA_DECREASE']) {  ?>

							<br />
							<span class="karma-icons">
								<?php if ($this->_rootref['U_KARMA_INCREASE']) {  ?>

									<span class="karma-increase-icon">
										<a href="<?php echo (isset($this->_rootref['U_KARMA_INCREASE'])) ? $this->_rootref['U_KARMA_INCREASE'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_KARMA_INCREASE'])) ? $this->_rootref['L_KARMA_INCREASE'] : ((isset($user->lang['KARMA_INCREASE'])) ? $user->lang['KARMA_INCREASE'] : '{ KARMA_INCREASE }')); ?>">
											<span><?php echo ((isset($this->_rootref['L_KARMA_INCREASE'])) ? $this->_rootref['L_KARMA_INCREASE'] : ((isset($user->lang['KARMA_INCREASE'])) ? $user->lang['KARMA_INCREASE'] : '{ KARMA_INCREASE }')); ?></span>
										</a>
									</span>
								<?php } if ($this->_rootref['U_KARMA_DECREASE']) {  ?>

									<span class="karma-decrease-icon">
										<a href="<?php echo (isset($this->_rootref['U_KARMA_DECREASE'])) ? $this->_rootref['U_KARMA_DECREASE'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_KARMA_DECREASE'])) ? $this->_rootref['L_KARMA_DECREASE'] : ((isset($user->lang['KARMA_DECREASE'])) ? $user->lang['KARMA_DECREASE'] : '{ KARMA_DECREASE }')); ?>">
											<span><?php echo ((isset($this->_rootref['L_KARMA_DECREASE'])) ? $this->_rootref['L_KARMA_DECREASE'] : ((isset($user->lang['KARMA_DECREASE'])) ? $user->lang['KARMA_DECREASE'] : '{ KARMA_DECREASE }')); ?></span>
										</a>
									</span>
								<?php } ?>
			...
			<?php } ?><!-- [-] Karma MOD //--><?php if ($this->_rootref['ONLINE_IMG']) {  ?>
		...
		<td class="row1">
			...
			<!-- Start Ultimate Points --><?php if ($this->_rootref['USE_POINTS']) {  ?>

				<tr>
					<td class="gen" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" nowrap="nowrap"><?php echo ((isset($this->_rootref['L_POINTS_CASH_ON_HAND'])) ? $this->_rootref['L_POINTS_CASH_ON_HAND'] : ((isset($user->lang['POINTS_CASH_ON_HAND'])) ? $user->lang['POINTS_CASH_ON_HAND'] : '{ POINTS_CASH_ON_HAND }')); ?>: </td>
					<td width="100%">
						<b class="gen">
							<?php if ($this->_rootref['U_LOCKED']) {  ?>

								<b><?php echo ((isset($this->_rootref['L_POINTS_LOCKED'])) ? $this->_rootref['L_POINTS_LOCKED'] : ((isset($user->lang['POINTS_LOCKED'])) ? $user->lang['POINTS_LOCKED'] : '{ POINTS_LOCKED }')); ?></b>
							<?php } else { ?>

								<?php echo (isset($this->_rootref['U_POINTS1'])) ? $this->_rootref['U_POINTS1'] : ''; ?> 
								...
								<br />
								<a href="<?php echo (isset($this->_rootref['U_POINTS_DONATE'])) ? $this->_rootref['U_POINTS_DONATE'] : ''; ?>"><?php echo ((isset($this->_rootref['L_DONATE'])) ? $this->_rootref['L_DONATE'] : ((isset($user->lang['DONATE'])) ? $user->lang['DONATE'] : '{ DONATE }')); ?></a> 
								<a href="<?php echo (isset($this->_rootref['U_POINTS_MODIFY'])) ? $this->_rootref['U_POINTS_MODIFY'] : ''; ?>"><?php echo ((isset($this->_rootref['L_MOD_USER_POINTS'])) ? $this->_rootref['L_MOD_USER_POINTS'] : ((isset($user->lang['MOD_USER_POINTS'])) ? $user->lang['MOD_USER_POINTS'] : '{ MOD_USER_POINTS }')); ?></a>
							<?php } ?>
				...
				<?php if ($this->_rootref['USE_BANK']) {  $_has_account_count = (isset($this->_tpldata['has_account'])) ? sizeof($this->_tpldata['has_account']) : 0;if ($_has_account_count) {for ($_has_account_i = 0; $_has_account_i < $_has_account_count; ++$_has_account_i){$_has_account_val = &$this->_tpldata['has_account'][$_has_account_i]; ?>

						<tr>
							<td class="gen" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" nowrap="nowrap"><?php echo ((isset($this->_rootref['L_BANK_BALANCE'])) ? $this->_rootref['L_BANK_BALANCE'] : ((isset($user->lang['BANK_BALANCE'])) ? $user->lang['BANK_BALANCE'] : '{ BANK_BALANCE }')); ?>: </td>
							<td width="100%">
								<b class="gen">
									<?php if ($this->_rootref['U_BLOCKED']) {  ?>

										<b><?php echo ((isset($this->_rootref['L_POINTS_LOCKED'])) ? $this->_rootref['L_POINTS_LOCKED'] : ((isset($user->lang['POINTS_LOCKED'])) ? $user->lang['POINTS_LOCKED'] : '{ POINTS_LOCKED }')); ?></b>
									<?php } else { ?> 
										<?php echo (isset($this->_rootref['BANK_GOLD'])) ? $this->_rootref['BANK_GOLD'] : ''; ?> 
										...
										<br />
										<a href="<?php echo (isset($this->_rootref['U_BANK_MODIFY'])) ? $this->_rootref['U_BANK_MODIFY'] : ''; ?>"><?php echo ((isset($this->_rootref['L_MOD_USER_BANK'])) ? $this->_rootref['L_MOD_USER_BANK'] : ((isset($user->lang['MOD_USER_BANK'])) ? $user->lang['MOD_USER_BANK'] : '{ MOD_USER_BANK }')); ?></a>
									<?php } ?>
					...
					<?php }} $_no_account_count = (isset($this->_tpldata['no_account'])) ? sizeof($this->_tpldata['no_account']) : 0;if ($_no_account_count) {for ($_no_account_i = 0; $_no_account_i < $_no_account_count; ++$_no_account_i){$_no_account_val = &$this->_tpldata['no_account'][$_no_account_i]; ?>
						...
						<tr>
							<td class="gen" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" nowrap="nowrap"><?php echo ((isset($this->_rootref['L_BANK_BALANCE'])) ? $this->_rootref['L_BANK_BALANCE'] : ((isset($user->lang['BANK_BALANCE'])) ? $user->lang['BANK_BALANCE'] : '{ BANK_BALANCE }')); ?>: </td>
							<td width="100%"><b class="gen"><?php echo $_no_account_val['BANK_NO_ACCOUNT']; ?></b></td>
						</tr>
					<?php }} } } ?><!-- End Ultimate Points --><?php if ($this->_rootref['S_WARNINGS']) {  ?>
			...
			<tr>
				<td class="gen" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" valign="top" nowrap="nowrap"><?php echo ((isset($this->_rootref['L_MEDALS_VIEW'])) ? $this->_rootref['L_MEDALS_VIEW'] : ((isset($user->lang['MEDALS_VIEW'])) ? $user->lang['MEDALS_VIEW'] : '{ MEDALS_VIEW }')); ?>:</td> <td><b class="gen"><?php echo (isset($this->_rootref['USER_MEDAL_COUNT'])) ? $this->_rootref['USER_MEDAL_COUNT'] : ''; ?></b><span class="genmed"> <?php if ($this->_rootref['U_CAN_AWARD_MEDALS']) {  ?>| <a href="<?php echo (isset($this->_rootref['U_CAN_AWARD_MEDALS'])) ? $this->_rootref['U_CAN_AWARD_MEDALS'] : ''; ?>"><strong><?php echo ((isset($this->_rootref['L_AWARD_MEDAL'])) ? $this->_rootref['L_AWARD_MEDAL'] : ((isset($user->lang['AWARD_MEDAL'])) ? $user->lang['AWARD_MEDAL'] : '{ AWARD_MEDAL }')); ?></strong></a><?php } if ($this->_rootref['U_NOMINATE']) {  ?> | <a href="<?php echo (isset($this->_rootref['U_NOMINATE'])) ? $this->_rootref['U_NOMINATE'] : ''; ?>"><strong><?php echo ((isset($this->_rootref['L_NOMINATE'])) ? $this->_rootref['L_NOMINATE'] : ((isset($user->lang['NOMINATE'])) ? $user->lang['NOMINATE'] : '{ NOMINATE }')); ?></strong></a><?php } ?></span></td>
			</tr>
	...
	<?php } ?><!-- Medals --><?php $this->_tpl_include('medals/medal_memberlist_view.html'); ?><!-- End medals -->
