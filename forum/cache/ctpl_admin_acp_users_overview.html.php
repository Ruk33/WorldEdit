...
<!-- [+] Karma MOD //-->
<dl>
	<dt><label><?php echo ((isset($this->_rootref['L_KARMA'])) ? $this->_rootref['L_KARMA'] : ((isset($user->lang['KARMA'])) ? $user->lang['KARMA'] : '{ KARMA }')); ?>:</label></dt>
	<dd><strong><?php echo (isset($this->_rootref['USER_KARMA'])) ? $this->_rootref['USER_KARMA'] : ''; ?></strong></dd>
</dl>
<!-- [-] Karma MOD //-->
<dl>
...
<dl>
	<dt><label><?php echo ((isset($this->_rootref['L_USER_POINTS'])) ? $this->_rootref['L_USER_POINTS'] : ((isset($user->lang['USER_POINTS'])) ? $user->lang['USER_POINTS'] : '{ USER_POINTS }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_USER_POINTS_EXPLAIN'])) ? $this->_rootref['L_USER_POINTS_EXPLAIN'] : ((isset($user->lang['USER_POINTS_EXPLAIN'])) ? $user->lang['USER_POINTS_EXPLAIN'] : '{ USER_POINTS_EXPLAIN }')); ?></span></dt>
	<dd><input class="text" type="text" id="user_points" maxlength="16" name="user_points" value="<?php echo (isset($this->_rootref['USER_POINTS'])) ? $this->_rootref['USER_POINTS'] : ''; ?>" /></dd>
</dl>
<!-- End Ultimate Points -->
