...
<form method="post" action="<?php echo (isset($this->_rootref['S_IM_ACTION'])) ? $this->_rootref['S_IM_ACTION'] : ''; ?>">
	...
	<tr>
		...
		<td class="row2"><span class="gen"><b><?php echo (isset($this->_rootref['USERNAME'])) ? $this->_rootref['USERNAME'] : ''; ?></b><?php if ($this->_rootref['S_SEND_ICQ'] || $this->_rootref['S_SEND_AIM'] || $this->_rootref['S_SEND_MSNM'] || $this->_rootref['S_NO_SEND_JABBER']) {  ?> [ <?php echo (isset($this->_rootref['IM_CONTACT'])) ? $this->_rootref['IM_CONTACT'] : ''; ?> ]<?php } ?></span> <?php if ($this->_rootref['PRESENCE_IMG']) {  echo (isset($this->_rootref['PRESENCE_IMG'])) ? $this->_rootref['PRESENCE_IMG'] : ''; } ?></td>
	</tr>
