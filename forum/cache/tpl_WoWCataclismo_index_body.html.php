...
<?php } ?><!-- Start Ultimate Points --><?php if ($this->_rootref['S_DISPLAY_POINTS_STATS']) {  ?>

	<br clear="all">

	<table class="tablebg" width="100%" cellspacing="1">
	<tr>
		<td class="cat" colspan="2"><h4><?php echo ((isset($this->_rootref['L_POINTS_STATISTICS'])) ? $this->_rootref['L_POINTS_STATISTICS'] : ((isset($user->lang['POINTS_STATISTICS'])) ? $user->lang['POINTS_STATISTICS'] : '{ POINTS_STATISTICS }')); ?></h4></td>
	</tr>
	<tr>
		<td class="row1" align="center" valign="middle"></td>
		<td class="row1" width="100%">
			<p class="genmed">
				<?php echo (isset($this->_rootref['TOTAL_POINTS_USER'])) ? $this->_rootref['TOTAL_POINTS_USER'] : ''; ?> &bull; <?php echo (isset($this->_rootref['TOTAL_BANK_USER'])) ? $this->_rootref['TOTAL_BANK_USER'] : ''; ?> &bull; <?php echo (isset($this->_rootref['TOTAL_BANK_POINTS'])) ? $this->_rootref['TOTAL_BANK_POINTS'] : ''; ?> 
				<?php if ($this->_rootref['S_DISPLAY_LOTTERY']) {  ?> 
					&bull; <?php echo (isset($this->_rootref['LOTTERY_TIME'])) ? $this->_rootref['LOTTERY_TIME'] : ''; ?> 
				<?php } ?>
...
<?php } if ($this->_rootref['S_DISPLAY_INDEX']) {  ?>

	<br clear="all">

	<table class="tablebg" width="100%" cellspacing="1">
	<tr>
		<td class="cat" colspan="2"><h4><?php echo ((isset($this->_rootref['L_POINTS_MOST_RICH_USERS'])) ? $this->_rootref['L_POINTS_MOST_RICH_USERS'] : ((isset($user->lang['POINTS_MOST_RICH_USERS'])) ? $user->lang['POINTS_MOST_RICH_USERS'] : '{ POINTS_MOST_RICH_USERS }')); ?></h4></td>
	</tr>
	<tr>
		<td class="row1" align="center" valign="middle"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/ChestOfGold.jpg" alt="<?php echo ((isset($this->_rootref['L_POINTS_MOST_RICH_USERS'])) ? $this->_rootref['L_POINTS_MOST_RICH_USERS'] : ((isset($user->lang['POINTS_MOST_RICH_USERS'])) ? $user->lang['POINTS_MOST_RICH_USERS'] : '{ POINTS_MOST_RICH_USERS }')); ?>" /></td>
		<td class="row1" width="100%">
			<p class="genmed">
				<?php $_rich_user_count = (isset($this->_tpldata['rich_user'])) ? sizeof($this->_tpldata['rich_user']) : 0;if ($_rich_user_count) {for ($_rich_user_i = 0; $_rich_user_i < $_rich_user_count; ++$_rich_user_i){$_rich_user_val = &$this->_tpldata['rich_user'][$_rich_user_i]; if (! $_rich_user_val['S_FIRST_ROW']) {  ?> 
						&bull; 
					<?php } ?>

					<?php echo $_rich_user_val['USERNAME']; ?> (<?php echo $_rich_user_val['SUM_POINTS']; ?> <?php echo $_rich_user_val['SUM_POINTS_NAME']; ?>)
				<?php }} ?>
...
<?php } ?><!-- End Ultimate Points --><!-- [+] Karma MOD --><?php if ($this->_rootref['KARMA_TOPLIST']) {  ?>

	<br clear="all" />
	<table class="tablebg" width="100%" cellspacing="1">
	<tr>
		<td class="cat" colspan="2"><h4><?php echo ((isset($this->_rootref['L_KARMA_TOPLIST'])) ? $this->_rootref['L_KARMA_TOPLIST'] : ((isset($user->lang['KARMA_TOPLIST'])) ? $user->lang['KARMA_TOPLIST'] : '{ KARMA_TOPLIST }')); ?></h4></td>
	</tr>
	<tr>
		<td class="row1" align="center" valign="middle"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/karmatoplist.jpg" alt="<?php echo ((isset($this->_rootref['L_KARMA_TOPLIST'])) ? $this->_rootref['L_KARMA_TOPLIST'] : ((isset($user->lang['KARMA_TOPLIST'])) ? $user->lang['KARMA_TOPLIST'] : '{ KARMA_TOPLIST }')); ?>" /></td>
		<td class="row1" width="100%">
			<p class="genmed">
				<?php echo ((isset($this->_rootref['L_KARMA_TOPLIST_EXPLAIN'])) ? $this->_rootref['L_KARMA_TOPLIST_EXPLAIN'] : ((isset($user->lang['KARMA_TOPLIST_EXPLAIN'])) ? $user->lang['KARMA_TOPLIST_EXPLAIN'] : '{ KARMA_TOPLIST_EXPLAIN }')); ?>: <b><?php echo (isset($this->_rootref['KARMA_TOPLIST'])) ? $this->_rootref['KARMA_TOPLIST'] : ''; ?></b>
			</p>
		</td>
	</tr>
	</table>
<?php } ?><!-- [-] Karma MOD --><?php if ($this->_rootref['S_DISPLAY_BIRTHDAY_LIST']) {  ?>
	...
	<tr>
		<td class="row1" align="center" valign="middle"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/birthdayicon.png" alt="<?php echo ((isset($this->_rootref['L_BIRTHDAYS'])) ? $this->_rootref['L_BIRTHDAYS'] : ((isset($user->lang['BIRTHDAYS'])) ? $user->lang['BIRTHDAYS'] : '{ BIRTHDAYS }')); ?>" /></td>
...
<tr>
	<td class="row1"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/statsII.png" alt="<?php echo ((isset($this->_rootref['L_STATISTICS'])) ? $this->_rootref['L_STATISTICS'] : ((isset($user->lang['STATISTICS'])) ? $user->lang['STATISTICS'] : '{ STATISTICS }')); ?>" /></td>
