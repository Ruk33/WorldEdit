...
<?php $_forumrow_count = (isset($this->_tpldata['forumrow'])) ? sizeof($this->_tpldata['forumrow']) : 0;if ($_forumrow_count) {for ($_forumrow_i = 0; $_forumrow_i < $_forumrow_count; ++$_forumrow_i){$_forumrow_val = &$this->_tpldata['forumrow'][$_forumrow_i]; if ($_forumrow_val['S_IS_CAT']) {  ?>
	...
	<?php } else if ($_forumrow_val['S_IS_LINK']) {  ?>
		...
		<tr>
			<td class="row1b" width="50" align="center"><?php echo $_forumrow_val['FORUM_FOLDER_IMG']; ?></td>
			<td class="row1">
		...
		<tr>
			...
			<td class="row1" width="100%">
				...
				<?php if ($_forumrow_val['MODERATORS']) {  ?>
					...
					<p class="forumdesc"><?php echo $_forumrow_val['L_MODERATOR_STR']; ?>: <?php echo $_forumrow_val['MODERATORS']; ?></p>
			...
			<td class="row2s" align="center"><p class="topicdetails"><?php echo $_forumrow_val['TOPICS']; ?></p></td>
			<td class="row2s" align="center"><p class="topicdetails"><?php echo $_forumrow_val['POSTS']; ?></p></td>
