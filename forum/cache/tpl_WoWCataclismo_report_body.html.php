...
<tr>
	<th colspan="2"><?php if ($this->_rootref['S_REPORT_POST']) {  echo ((isset($this->_rootref['L_REPORT_POST'])) ? $this->_rootref['L_REPORT_POST'] : ((isset($user->lang['REPORT_POST'])) ? $user->lang['REPORT_POST'] : '{ REPORT_POST }')); } else { echo ((isset($this->_rootref['L_REPORT_MESSAGE'])) ? $this->_rootref['L_REPORT_MESSAGE'] : ((isset($user->lang['REPORT_MESSAGE'])) ? $user->lang['REPORT_MESSAGE'] : '{ REPORT_MESSAGE }')); } ?></th>
</tr>
<tr>
	<td class="row3" colspan="2"><span class="gensmall"><?php if ($this->_rootref['S_REPORT_POST']) {  echo ((isset($this->_rootref['L_REPORT_POST_EXPLAIN'])) ? $this->_rootref['L_REPORT_POST_EXPLAIN'] : ((isset($user->lang['REPORT_POST_EXPLAIN'])) ? $user->lang['REPORT_POST_EXPLAIN'] : '{ REPORT_POST_EXPLAIN }')); } else { echo ((isset($this->_rootref['L_REPORT_MESSAGE_EXPLAIN'])) ? $this->_rootref['L_REPORT_MESSAGE_EXPLAIN'] : ((isset($user->lang['REPORT_MESSAGE_EXPLAIN'])) ? $user->lang['REPORT_MESSAGE_EXPLAIN'] : '{ REPORT_MESSAGE_EXPLAIN }')); } ?></span></td>
</tr>
<tr>
