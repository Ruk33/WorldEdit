...
/**
* Same as get_unread_topics but this function will return
* "all" the topic's data (not just the id)
*
* @param int $sql_limit		How many topics to return?
*
* @return array				All unread topics
*/
function get_unread_topics_data($sql_limit = 5)
{
	global $db, $user;
	...
	$sql_array = array(
		'SELECT'		=> 't.topic_id, t.forum_id, t.topic_title, t.topic_first_poster_name, t.topic_first_poster_colour, t.topic_last_poster_id, t.topic_last_post_time, tt.mark_time as topic_mark_time, ft.mark_time as forum_mark_time, f.forum_name',
	...
	$sql = $db->sql_build_query('SELECT', $sql_array);
	$unread_topics = $db->sql_query_limit($sql, $sql_limit, 0);
