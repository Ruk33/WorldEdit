...
/** 
*
* mcp.php [Argentinian Spanish (Formal Honorifics)]
*
* @package language
* @version $Id: $
...
$lang = array_merge($lang, array(
	...
	'ADD_FEEDBACK_EXPLAIN'	=> 'Si querés enviar un informe, por favor completá el siguiente formulario. Empleá solo texto plano; HTML, BBCode, etc. no está permitido.',
	'ADD_WARNING'			=> 'Añadir advertencia',
	'ADD_WARNING_EXPLAIN'	=> 'Para enviar una advertencia a estos usuarios por favor completá el siguiente formulario. Empleá solo texto plano; HTML, BBCode, etc. no está permitido.',
	...
	'APPROVE_POST_CONFIRM'	=> '¿Estás seguro de que querés aprobar este mensaje?',
	'APPROVE_POSTS'			=> 'Aprobar mensajes',
	'APPROVE_POSTS_CONFIRM'	=> '¿Estás seguro de que quéres aprobar estos mensajes?',

	'AUTO_WARN_BAN'	=> 'El usuario ha alcanzado la máxima cantidad de advertencias, y fue baneado automáticamente.',

	'CANNOT_MOVE_SAME_FORUM'	=> 'No podés mover un tema al Foro en el que ya se encuentra',
	'CANNOT_WARN_ANONYMOUS'		=> 'No podés advertir a un usuario no registrado',
	'CANNOT_WARN_SELF'			=> 'No podés advertirte a vos mismo',
	'CAN_LEAVE_BLANK'			=> 'No puede estar en blanco.',
	'CHANGE_POSTER'				=> 'Cambiar autor',
	'CLOSE_PM_REPORT'		=> 'Cerrar informe de MP',
	'CLOSE_PM_REPORT_CONFIRM'	=> '¿Estás seguro de que querés cerrar el informe de MP seleccionado?',
	'CLOSE_PM_REPORTS'		=> 'Cerrar informes de MP',
	'CLOSE_PM_REPORTS_CONFIRM'	=> '¿Estás seguro de que querés cerrar los informes de MP seleccionados?',
	'CLOSE_REPORT'				=> 'Cerrar informe',
	'CLOSE_REPORT_CONFIRM'		=> '¿Estás seguro de que querés cerrar el informe seleccionado?',
	'CLOSE_REPORTS'				=> 'Cerrar informes',
	'CLOSE_REPORTS_CONFIRM'		=> '¿Estás seguro de que querés cerrar los informes seleccionados?',

	'DELETE_PM_REPORT'			=> 'Borrar informe de MP',
	'DELETE_PM_REPORT_CONFIRM'	=> '¿Estás seguro de que querés borrar el informe de MP seleccionado?',
	'DELETE_PM_REPORTS'			=> 'Borrar informes de MP',
	'DELETE_PM_REPORTS_CONFIRM'	=> '¿Estás seguro de que querés borrar los informes de MP seleccionados?',
	'DELETE_POSTS'				=> 'Borrar mensajes',
	'DELETE_POSTS_CONFIRM'		=> '¿Estás seguro de que querés borrar estos mensajes?',
	'DELETE_POST_CONFIRM'		=> '¿Estás seguro de que querés borrar este mensaje?',
	'DELETE_REPORT'				=> 'Borrar informe',
	'DELETE_REPORT_CONFIRM'		=> '¿Estás seguro de que querés borrar el informe seleccionado?',
	'DELETE_REPORTS'			=> 'Borrar informes',
	'DELETE_REPORTS_CONFIRM'	=> '¿Estás seguro de que querés borrar los informes seleccionados?',
	'DELETE_SHADOW_TOPIC'		=> 'Borrar tema sombreado',
	'DELETE_TOPICS'				=> 'Borrar temas',
	'DELETE_TOPICS_CONFIRM'		=> '¿Estás seguro de que querés borrar estos temas?',
	'DELETE_TOPIC_CONFIRM'		=> '¿Estás seguro de que querés borrar este tema?',
	'DISAPPROVE'				=> 'Desaprobar',
	'DISAPPROVE_REASON'			=> 'Razón de la desaprobación',
	'DISAPPROVE_POST'			=> 'Desaprobar mensaje',
	'DISAPPROVE_POST_CONFIRM'	=> '¿Estás seguro de que querés desaprobar este mensaje?',
	'DISAPPROVE_POSTS'			=> 'Desaprobar mensajes',
	'DISAPPROVE_POSTS_CONFIRM'	=> '¿Estás seguro de que querés desaprobar los mensajes seleccionados?',
	'DISPLAY_LOG'				=> 'Mostrar entradas previas',
	'DISPLAY_OPTIONS'			=> 'Opciones de visualización',

	'EMPTY_REPORT'				=> 'Tenés que introducir una descripción cuando seleccionás esta razón',
	'EMPTY_TOPICS_REMOVED_WARNING'	=> 'Por favor observá que uno o varios temas han sido eliminados de la base de datos porque estaban vacíos',

	'FEEDBACK'					=> 'Feedback',
	'FORK'						=> 'División',
	'FORK_TOPIC'				=> 'Dividir tema',
	'FORK_TOPIC_CONFIRM'		=> '¿Estás seguro de que querés dividir el tema?',
	'FORK_TOPICS'				=> 'Dividir temas seleccionados',
	'FORK_TOPICS_CONFIRM'		=> '¿Estás seguro de que querés dividir los temas seleccionados?',
	...
	'LEAVE_SHADOW'				=> 'Dejar tema sombreado acá',
	'LIST_REPORT'				=> '1 informe',
	'LIST_REPORTS'				=> '%d informes',
	'LOCK'						=> 'Cerrado',
	'LOCK_POST_POST'			=> 'Bloquear mensaje',
	'LOCK_POST_POST_CONFIRM'	=> '¿Estás seguro de que querés evitar que este mensaje se edite?',
	'LOCK_POST_POSTS'			=> 'Bloquear mensajes seleccionados',
	'LOCK_POST_POSTS_CONFIRM'	=> '¿Estás seguro de que querés evitar que estos mensajes se editen?',
	'LOCK_TOPIC_CONFIRM'		=> '¿Estás seguro de que querés bloquear este tema?',
	'LOCK_TOPICS'				=> 'Bloquear temas seleccionados',
	'LOCK_TOPICS_CONFIRM'		=> '¿Estás seguro de que querés bloquear los temas seleccionados?',
	...
	'MCP_MAKE_ANNOUNCEMENT_CONFIRM'		=> '¿Estás seguro de que querés convertir este tema en un "Anuncio"?',
	'MCP_MAKE_ANNOUNCEMENTS'			=> 'Convertir en "Anuncios"',
	'MCP_MAKE_ANNOUNCEMENTS_CONFIRM'	=> '¿Estás seguro de que querés convertir los temas seleccionados en "Anuncios"?',
	'MCP_MAKE_GLOBAL'					=> 'Convertir en "Anuncio global"',
	'MCP_MAKE_GLOBAL_CONFIRM'			=> '¿Estás seguro de que querés convertir este tema en un "Anuncio global"?',
	'MCP_MAKE_GLOBALS'					=> 'Convertir en "Anuncios globales"',
	'MCP_MAKE_GLOBALS_CONFIRM'			=> '¿Estás seguro de que querés convertir los temas seleccionados en "Anuncios globales?',
	'MCP_MAKE_STICKY'					=> 'Convertir en "Fijo"',
	'MCP_MAKE_STICKY_CONFIRM'			=> '¿Estás seguro de que querés convertir este tema en "Fijo"?',
	'MCP_MAKE_STICKIES'					=> 'Convertir en "Fijos"',
	'MCP_MAKE_STICKIES_CONFIRM'			=> '¿Estás seguro de que querés convertir los temas seleccionados en "Fijos"?',
	'MCP_MAKE_NORMAL'					=> 'Convertir en "Tema Normal"',
	'MCP_MAKE_NORMAL_CONFIRM'			=> '¿Estás seguro de que querés convertir este tema en "Tema Normal"?',
	'MCP_MAKE_NORMALS'					=> 'Convertir en "Temas Normales"',
	'MCP_MAKE_NORMALS_CONFIRM'			=> '¿Estás seguro de que querés convertir los temas seleccionados en "Temas Normales"?',
	...
	'MCP_QUEUE_UNAPPROVED_POSTS_EXPLAIN'	=> 'Esta es una lista de los mensajes que requerésn aprobación antes de que sean visibles a los usuarios',
	'MCP_QUEUE_UNAPPROVED_TOPICS'			=> 'Temas esperando aprobación',
	'MCP_QUEUE_UNAPPROVED_TOPICS_EXPLAIN'	=> 'Esta es una lista de los temas que requerésn aprobación antes de que sean visibles a los usuarios',
	...
	'MERGE_TOPIC_EXPLAIN'	=> 'Usando el siguiente formulario podés mover los mensajes seleccionados a otro tema. Los mensajes se separarán de este tema y se unirán en el otro tema. Estos mensajes no serán reordenados y aparecerán como si los usuarios los hubiesen publicado en el nuevo tema.<br />Por favor ingrese el id del tema de destino o haga clic en el botón "Seleccionar" para buscar uno.',
	'MERGE_TOPIC_ID'		=> 'Número de identificación del tema de destino',
	'MERGE_TOPICS'			=> 'Unir temas',
	'MERGE_TOPICS_CONFIRM'	=> '¿Estás seguro de que querés unir los temas seleccionados?',
	...
	'MOVE_TOPIC_CONFIRM'	=> '¿Estás seguro de que querés mover este tema a un nuevo foro?',
	'MOVE_TOPICS'			=> 'Mover temas seleccionados',
	'MOVE_TOPICS_CONFIRM'	=> '¿Estás seguro de que querés mover los temas seleccionados a un nuevo foro?',
	...
	'NOT_MODERATOR'					=> 'No sos moderador de este Foro',
	...
	'NO_POST'						=> 'Debés seleccionar un mensaje para advertir al usuario',
	'NO_POST_REPORT'				=> 'No se ha informado de este mensaje.',
	'NO_POST_SELECTED'				=> 'Debés seleccionar al menos un mensaje para efectuar esta acción',
	'NO_REASON_DISAPPROVAL'			=> 'Por favor proporcioná una razón apropiada para desaprobar',
	'NO_REPORT'						=> 'No se encontró informe',
	'NO_REPORTS'					=> 'No hay informes',
	'NO_REPORT_SELECTED'			=> 'Tenés que seleccionar al menos un informe para ejecutar esta acción.',
	'NO_TOPIC_ICON'					=> 'Ninguno',
	'NO_TOPIC_SELECTED'				=> 'Debés seleccionar al menos un tema para efectuar esta acción',
	...
	'POSTS_PER_PAGE_EXPLAIN'		=> '(Poné 0 para ver todos los mensajes)',
	...
	'REPORT_MESSAGE_EXPLAIN'	=> 'Utilizá este formulario para informar sobre el mensaje privado seleccionado. En general debería informarse solo si el mensaje rompe las reglas del foro. <strong>Informar sobre un mensaje privado hará que su contenido visible a todos los moderadores.</strong>',
	'REPORT_NOTIFY'				=> 'Notificarme',
	'REPORT_NOTIFY_EXPLAIN'		=> 'Se te informará cuando se lea tu informe',
	'REPORT_POST_EXPLAIN'		=> 'Utilizá este formulario para informar del mensaje seleccionado al moderador del foro y administradores del Sitio. En general debería informarse solo si el mensaje rompe las reglas del foro.',
	...
	'SELECT_FORUM_GLOBAL_ANNOUNCEMENTS'	=> 'Uno o más de los temas seleccionados son anuncios globales. Por favor seleccioná el foro en el que desea mostrarlos.',
	...
	'SPLIT_TOPIC_ALL_CONFIRM'			=> '¿Estás seguro de que querés dividir este tema?',
	'SPLIT_TOPIC_BEYOND'				=> 'Enviar tema al mensaje seleccionado',
	'SPLIT_TOPIC_BEYOND_CONFIRM'		=> '¿Estás seguro de que querés enviar este tema al mensaje seleccionado?',
	'SPLIT_TOPIC_EXPLAIN'				=> 'Usando el formulario de debajo podés dividir un tema en dos, bien seleccionando mensajes individuales o bien dividiendo el mensaje elegido',
	...
	'UNLOCK_POST_POST_CONFIRM'			=> '¿Estás seguro de que querés permitir la edición de este mensaje?',
	'UNLOCK_POST_POSTS'					=> 'Desbloquear mensajes',
	'UNLOCK_POST_POSTS_CONFIRM'			=> '¿Estás seguro de que querés permitir la edición de estos mensajes?',
	'UNLOCK_TOPIC'						=> 'Desbloquear tema',
	'UNLOCK_TOPIC_CONFIRM'				=> '¿Estás seguro de que querés desbloquear este tema?',
	'UNLOCK_TOPICS'						=> 'Desbloquear temas',
	'UNLOCK_TOPICS_CONFIRM'				=> '¿Estás sequro que querés desbloquear los temas seleccionados?',
	...
	'WARNING_POST_DEFAULT'		=> 'Esta es una advertencia al siguiente mensaje creado por vos: %s',
	...
	'report_reasons'	=> array(
		...
		'DESCRIPTION'	=> array(
			...
			'OTHER'		=> 'El mensaje reportado no cuadra en ninguna categoría, por favor completá el campo descripción',
		),
	),
));
