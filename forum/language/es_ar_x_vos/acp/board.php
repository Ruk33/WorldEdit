...
/** 
*
* acp_board.php [Argentinian Spanish (Formal Honorifics)]
*
* @package language
* @version $Id: $
...
$lang = array_merge($lang, array(
	'ACP_BOARD_SETTINGS_EXPLAIN'	=> 'Acá podés determinar las operaciones básicas de tu Sitio, desde el nombre pasando por el registro de usuarios hasta los mensajes privados.',
	...
	'DISABLE_BOARD_EXPLAIN'			=> 'Esto hará al Sitio inaccesible a los usuarios. Si querés, también podés introducir un breve mensaje (255 caracteres) para mostrar.',
	'OVERRIDE_STYLE'				=> 'Sustituir estilo del usuario',
	'OVERRIDE_STYLE_EXPLAIN'		=> 'Reemplazá el estilo del usuario por el estilo por defecto.',
	...
	'WARNINGS_BAN'					=> 'Números de advertencias antes de que los usuarios sean baneados',
	'WARNINGS_BAN_EXPLAIN'			=> 'Números de advertencias antes de que los usuarios sean automáticamente baneados.',
	'WARNINGS_BAN_EXPIRE'			=> 'Tiempo de expiración de los bans automáticos',
	'WARNINGS_BAN_EXPIRE_EXPLAIN'	=> 'El tiempo (en minutos) en el que los baneos automáticos por X advertencias expiran.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_BIRTHDAYS_EXPLAIN'		=> 'Permitir la introducción de cumpleaños y que la edad sea visualizada en los perfiles. Por favor tené en cuenta que la lista de cumpleaños en el Índice del Foro está controlada por otro parámetro.',
	...
	'BOARD_PM_EXPLAIN'				=> 'Habilitá o deshabilitá mensajes privados para todos los usuarios.',
));

// Avatar Settings
$lang = array_merge($lang, array(
	'ACP_AVATAR_SETTINGS_EXPLAIN'	=> 'Los avatares son, por lo general, pequeñas imágenes distintivas que un usuario puede asociar a sí mismo. Dependiendo del estilo suelen ser mostrados debajo del nombre de usuario cuando se lea un tema. Acá podés establecer cómo podrán determinar los usuarios sus propios avatares. Por favor tené en cuenta que para subir avatares necesita haber creado el directorio que se configura abajo y asegurarse de que pueda ser escrito por el servidor Web. Por favor tené también en cuenta que los límites en el tamaño del archivo solo tienen efecto sobre los avatares subidos, no se aplican a las imágenes enlazadas fuera del Sitio.',
...
// Message Settings
$lang = array_merge($lang, array(
	'ACP_MESSAGE_SETTINGS_EXPLAIN'	=> 'Acá podés ajustar los parámetros por defecto de los mensajes privados',

	'ALLOW_BBCODE_PM'			=> 'Permitir BBCode en mensajes privados',
	'ALLOW_FLASH_PM'			=> 'Permitir uso de etiquetas BBCode <code>[FLASH]</code>',
	'ALLOW_FLASH_PM_EXPLAIN'	=> 'Observá que la capacidad de usar flash en mensajes privados, si está habilitado aquí, también depende de los permisos.',
	...
	'BOXES_LIMIT_EXPLAIN'		=> 'Los usuarios pueden recibir no más que esta cantidad de mensajes en cada una de sus bandejas de mensajes privados. Ajustá este valor a  0 para permitir mensajes ilimitados.',
	...
	'PM_EDIT_TIME_EXPLAIN'		=> 'Limita el tiempo disponible para editar un mensaje privado aún no entregado. Poné este valor a 0 para deshabilitar esta opción.',
...
// Post Settings
$lang = array_merge($lang, array(
	'ACP_POST_SETTINGS_EXPLAIN'			=> 'Acá podés ajustar los parámetros por defecto de los mensajes',
	...
	'BUMP_INTERVAL_EXPLAIN'			=> 'Número de minutos, horas o días entre el último mensaje de un tema y la capacidad de reactivar ese tema. Ajustá este valor a 0 para deshabilitar esta opción.',
	'CHAR_LIMIT'					=> 'Máximo de caracteres por mensaje',
	'CHAR_LIMIT_EXPLAIN'			=> 'El número de caracteres permitidos en un mensaje. Ajustá este valor a 0 para caracteres ilimitados.',
	'DELETE_TIME'					=> 'Límite para poder borrar',
	'DELETE_TIME_EXPLAIN'			=> 'Limita el tiempo disponible para borrar un nuevo mensaje. Insertá el valor 0 para deshabilitarlo.',
	...
	'EDIT_TIME_EXPLAIN'				=> 'Limita el tiempo disponible para editar un mensaje. Ajustá este valor a 0 para deshabilitar esta opción.',
	...
	'HOT_THRESHOLD_EXPLAIN'			=> 'Mensajes por tema requeridos para que sea considerado popular. Ajustá este valor a 0 para deshabilitar esta opción.',
	'MAX_POLL_OPTIONS'				=> 'Número máximo de opciones en encuestas',
	'MAX_POST_FONT_SIZE'			=> 'Tamaño máximo de fuente en mensajes.',
	'MAX_POST_FONT_SIZE_EXPLAIN'	=> 'Tamaño máximo de fuente permitido en un mensaje. Ajustá este valor a 0 para tamaño ilimitado.',
	'MAX_POST_IMG_HEIGHT'			=> 'Altura máxima de imagen en mensajes',
	'MAX_POST_IMG_HEIGHT_EXPLAIN'	=> 'Altura máxima de una imagen/flash en mensajes. Ajustá este valor a 0 para tamaño ilimitado.',
	'MAX_POST_IMG_WIDTH'			=> 'Ancho máximo de imagen en mensajes',
	'MAX_POST_IMG_WIDTH_EXPLAIN'	=> 'Ancho máximo de una imagen/flash en mensajes. Ajustá este valor a 0 para tamaño ilimitado.',
	'MAX_POST_URLS'					=> 'Máximo de enlaces por mensaje',
	'MAX_POST_URLS_EXPLAIN'			=> 'Número máximo de URLs en un mensaje. Ajustá este valor a 0 para enlaces ilimitados.',
	...
	'QUOTE_DEPTH_LIMIT_EXPLAIN'		=> 'Profundidad máxima de anidamiento de citas en un mensaje. Ajustá este valor a 0 para profundidad infinita.',
	'SMILIES_LIMIT'					=> 'Máximo de emoticonos por mensaje',
	'SMILIES_LIMIT_EXPLAIN'			=> 'Número máximo de emoticonos en un mensaje. Ajustá este valor a 0 para emoticonos ilimitados.',
...
// Signature Settings
$lang = array_merge($lang, array(
	'ACP_SIGNATURE_SETTINGS_EXPLAIN'	=> 'Acá podés ajustar los parámetros por defecto de las firmas',
	...
	'MAX_SIG_SMILIES_EXPLAIN'		=> 'Número máximo de emoticonos en un mensaje. Ajustá este valor a 0 para emoticonos ilimitados.',
	'MAX_SIG_URLS'					=> 'Máximo de enlaces por firma',
	'MAX_SIG_URLS_EXPLAIN'			=> 'Número máximo de URLs en un mensaje. Ajustá este valor a 0 para enlaces ilimitados.',
));

// Registration Settings
$lang = array_merge($lang, array(
	'ACP_REGISTER_SETTINGS_EXPLAIN'	=> 'Acá podés definir parámetros relativos al formulario de registro y el perfil',

	'ACC_ACTIVATION'			=> 'Activación de cuenta',
	'ACC_ACTIVATION_EXPLAIN'	=> 'Esto determina si los usuarios tienen acceso inmediato al Sitio o bien si se requiere confirmación. También pódes deshabilitar por completo nuevos registros.  “Email del Foro” debe estar habilitado para poder utilizar la activación de usuario o Administrador.',
	'NEW_MEMBER_POST_LIMIT'			=> 'Límite de mensajes para nuevos usuarios',
	'NEW_MEMBER_POST_LIMIT_EXPLAIN'	=> 'Los nuevos miembros se encuentran dentro del grupo <em>Nuevos Usuarios Registrados</em> hasta que alcancen este número de mensajes. Pódes usar este grupo para evitar el sistema de mensaje privados (MP) o revisar sus mensajes. <strong>Un valor de 0 deshabilita esta opción.</strong>',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_ENABLE_EXPLAIN'			=> 'Activá o desactivá los ATOM Feeds para todo el foro.<br />Deshabilitar esto desactiva todos los Feeds, sin importar cómo están configuradas las opciones de abajo.',
	...
	'ACP_FEED_NEWS_EXPLAIN'				=> 'Publica el primer mensaje de estos foros. No selecciones foros para deshabilitar los Feeds de Noticias.<br />Seleccioná multiples foros manteniendo pulsada la tecla <samp>CTRL</samp> y haciendo clic en los foros deseados.',
...
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'				=> 'Acá podés seleccionar y configurar los plugins designados para bloquear envíos de formulario por parte de robots de spam. Estos plugins suelen funcionar desafiando al usuario con un <em>CAPTCHA</em>, una prueba diseñada para que sea difícil de resolver por computadoras.',
    ...
    'CAPTCHA_GD_FONTS_EXPLAIN'            	=> 'Esta opción controla cuántas formas diferentes de letra se usarán. Podés simplemente usar las formas por defecto o introducir letras modificadas. Añadir letras minúsculas también es posible.',
	...
	'CAPTCHA_PREVIEW_EXPLAIN'				=> 'El plugin se verá así usando los parámetros actuales. Usá el botón de vista previa para actualizar. Observá que los plugins son aleatorios y difieren de una vista a otra.',
...
// Cookie Settings
$lang = array_merge($lang, array(
	'ACP_COOKIE_SETTINGS_EXPLAIN'	=> 'Estos detalles determinan los datos usados para enviar cookies a los navegadores de los usuarios. En la mayoría de los casos los valores por defecto para los configuración de las cookies deberían ser suficiente. Si necesitás cambiar algo, hacelo con cuidado, parámetros incorrectos impedirían que los usuarios puedan identificarse.',
	...
	'COOKIE_SECURE_EXPLAIN'		=> 'Si tu servidor emplea SSL, habilite esta opción, si no, déjelo deshabilitado. Habilitar esto sin usar SSL provocará errores en el servidor.',
...
// Load Settings
$lang = array_merge($lang, array(
	'ACP_LOAD_SETTINGS_EXPLAIN'	=> 'Acá podés habilitar y deshabilitar ciertas funciones del Sitio para reducir la cantidad de procesamiento requerido. En la mayoría de los servidores no hay necesidad de deshabilitar ninguna función. Sin embargo en ciertos sistemas o entornos compartidos puede ser beneficioso deshabilitar capacidades que no necesite realmente. También podés especificar límites para la carga de sistema y sesiones activas, superadas las cuales el Sitio se pondrá fuera de línea.',
	...
	'LIMIT_SESSIONS_EXPLAIN'		=> 'Si el número de sesiones excede este valor en el periodo de un minuto, el Sitio automáticamente se pondrá fuera de línea. Poné este valor en 0 para sesiones ilimitadas.',
	...
	'YES_JUMPBOX'					=> 'Habilitá mostrar \'Saltar a\'',
	'YES_MODERATORS'				=> 'Habilitá mostrar moderadores',
	'YES_ONLINE'					=> 'Habilitá listado de usuarios identificados',
	'YES_ONLINE_EXPLAIN'			=> 'Muestra una lista de usuarios identificados en inicio, foros y tema.',
	'YES_ONLINE_GUESTS'				=> 'Habilitá listado de invitados identificados en Ver Conectados',
	'YES_ONLINE_GUESTS_EXPLAIN'		=> 'Permite mostrar usuarios invitados en Ver Conectados.',
	'YES_ONLINE_TRACK'				=> 'Habilitá mostrar información de usuarios identificados/desconectados',
...
// Auth settings
$lang = array_merge($lang, array(
	'ACP_AUTH_SETTINGS_EXPLAIN'	=> 'phpBB soporta plugins de autentificación o módulos. Esto te permite determinar cómo se identifica a los usuarios cuando se conectan al Sitio. Por defecto se proveen tres plugins; DB, LDAP y Apache. No todos los métodos requieren información adicional, así que rellene solo los campos que sean relevantes para el método elegido.',

	'AUTH_METHOD'	=> 'Seleccioná un método de autentificación',

	'APACHE_SETUP_BEFORE_USE'	=> 'Tenés que configurar la autentificación de Apache antes de cambiar a este método. Tené en cuenta que el nombre de usuario que emplea para autentificación de Apache tiene que ser el mismo que usa en phpBB.',
	...
	'LDAP_EMAIL_EXPLAIN'	=> 'Configurá esto con el nombre del atributo de usuario de email entrante (si existe) para configurar automáticamente la dirección de email para nuevos usuarios. Dejar esto vacío provoca una dirección de email vacía para usuarios que ingresan por primera vez.',
	...
	'LDAP_PASSWORD_EXPLAIN'	=> 'Dejá en blanco para acceso anónimo. Si no, completálo con la contraseña de usuario. Obligatorio para servidores de Directorio Activo. <br /><em><strong>ADVERTENCIA:</strong> Esta contraseña será guardada como texto plano en la base de datos y será visible para cualquiera que tenga acceso a la misma o que pueda ver esta página de configuración.</em>',
	'LDAP_PORT'						=> 'Puerto de servidor LDAP',
	'LDAP_PORT_EXPLAIN'				=> 'Opcionalmente podés especificar un puerto que se usaría para conectar al servidor LDAP en vez del puerto por defecto 389.',
	'LDAP_SERVER'	=> 'Nombre de servidor LDAP',
	'LDAP_SERVER_EXPLAIN'	=> 'Si usás LDAP, éste es el nombre o dirección IP del servidor.',
	...
	'LDAP_USER_EXPLAIN'	=> 'Dejá en blanco para acceso anónimo. Si lo completa, phpBB conectará con el servidor LDAP como el usuario especificado.',
	'LDAP_USER_FILTER'				=> 'Filtro de usuario LDAP',
	'LDAP_USER_FILTER_EXPLAIN'		=> 'Opcionalmente podés limitar más los objetos buscados con filtros adicionales. Por ejemplo <samp>objectClass=posixGroup</samp> resultaría en el uso de <samp>(&amp;(uid=$username)(objectClass=posixGroup))</samp>',
));

// Server Settings
$lang = array_merge($lang, array(
	'ACP_SERVER_SETTINGS_EXPLAIN'	=> 'Acá podés definir parámetros relativos a dominio y servidor. Por favor verificá que los datos que introduzca sean exactos, los errores provocarían emails con información incorrecta. Cuando configurés el dominio, recuerde poner http:// u otro protocolo. Solo cambiá el número de puerto si sabés que su servidor emplea uno diferente, el puerto 80 está bien para la mayoría de los casos.',
	...
	'FORCE_SERVER_VARS_EXPLAIN'	=> 'Si configurás SÍ el parámetro definido aquí, será empleado en lugar del valor predeterminado automáticamente',
...
// Security Settings
$lang = array_merge($lang, array(
	'ACP_SECURITY_SETTINGS_EXPLAIN'		=> 'Acá podés definir parámetros relativos a conexión y sesiones',

	'ALL'								=> 'Todo',
	'ALLOW_AUTOLOGIN'					=> 'Permitir conexión persistente',
	'ALLOW_AUTOLOGIN_EXPLAIN'			=> 'Determiná si el usuario puede identificarse automáticamente cuando visita el Sitio.',
	...
	'BROWSER_VALID_EXPLAIN'				=> 'Habilitá la validación de navegador para cada sesión mejorando la seguridad.',
	...
	'FORCE_PASS_CHANGE_EXPLAIN'			=> 'Requiere que un usuario cambie su contraseña después de un número específico de días. Ajustá este valor a 0 para deshabilitar esta opción.',
	'FORM_TIME_MAX'					=> 'Tiempo máximo para enviar formularios',
	'FORM_TIME_MAX_EXPLAIN'			=> 'El tiempo que un usuario tiene para enviar un formulario. Use -1 para desactivarlo. Notá que un formulario puede volverse no válido si la sesión expira, independientemente de esta configuración.',
	...
	'PASSWORD_TYPE_EXPLAIN'				=> 'Determiná la complejidad necesaria para una contraseña, las opciones siguientes incluyen las precedentes.',
...
$lang = array_merge($lang, array(
	...
	'SMTP_AUTH_METHOD_EXPLAIN'		=> 'Solo usado si se configura usuario/contraseña, preguntále a tu ISP si no estás seguro de cual método usar.',
	'SMTP_CRAM_MD5'					=> 'CRAM-MD5',
	'SMTP_DIGEST_MD5'				=> 'DIGEST-MD5',
	'SMTP_LOGIN'					=> 'LOGIN',
	'SMTP_PASSWORD'					=> 'Contraseña SMTP',
	'SMTP_PASSWORD_EXPLAIN'			=> 'Introducí una contraseña solo si tu servidor SMTP lo requiere.<br /><em><strong>ADVERTENCIA:</strong> Esta contraseña será guardada como texto plano en la base de datos y será visible para cualquiera que tenga acceso a la misma o que pueda ver esta página de configuración.</em>',
	'SMTP_PLAIN'					=> 'PLAIN',
	'SMTP_POP_BEFORE_SMTP'			=> 'POP-BEFORE-SMTP',
	'SMTP_PORT'						=> 'Puerto servidor SMTP',
	'SMTP_PORT_EXPLAIN'				=> 'Cambiálo solo si sabe que su servidor SMTP está en un puerto diferente.',
	'SMTP_SERVER'					=> 'Dirección servidor SMTP',
	'SMTP_SETTINGS'					=> 'Configuración SMTP',
	'SMTP_USERNAME'					=> 'Usuario SMTP',
	'SMTP_USERNAME_EXPLAIN'			=> 'Solo introducí un usuario si tu servidor SMTP lo requiere.',
...
// Jabber settings
$lang = array_merge($lang, array(
	'ACP_JABBER_SETTINGS_EXPLAIN'	=> 'Acá podés habilitar y controlar el uso de Jabber para mensajería instantánea y avisos del Sitio. Jabber es un protocolo de código abierto y por lo tanto disponible para que lo use cualquiera. Algunos servidores Jabber le permiten contactar con usuarios en otras redes. No todos los servidores ofrecen todos los transportes, y los cambios en el protocolo pueden causar que algunos transportes dejen de funcionar. Observá que puede tomar varios segundos actualizar los datos de la cuenta Jabber, ¡no canceles el proceso hasta completarlo!',

	'JAB_ENABLE'				=> 'Habilitar Jabber',
	'JAB_ENABLE_EXPLAIN'		=> 'Habilitá el uso de mensajeria y notificaciones Jabber',
	'JAB_GTALK_NOTE'			=> 'Por favor fijate en que GTalk no funcionará porque no se encontró la función <samp>dns_get_record</samp>. Esta función no está disponible en PHP4, y no está implementada en plataformas Windows. Actualmente no funciona en sistemas basados en BSD, incluído Mac OS.',
	...
	'JAB_PORT_EXPLAIN'			=> 'Dejá en blanco a menos que sepa que no es el puerto 5222',
	'JAB_SERVER'				=> 'Servidor Jabber',
	'JAB_SERVER_EXPLAIN'		=> 'Visitá %sjabber.org%s para obtener una lista de servidores',
	...
	'JAB_USERNAME_EXPLAIN'		=> 'Especificá un nombre de usuario registrado o un JID válido. No se comprobará la validez del nombre de usuario. Si solo especifica un nombre de usuario entonces su JID será el nombre de usuario y el servidor que especificó arriba. Si no, especificá un JID válido, por ejemplo user@jabber.org.',
));
