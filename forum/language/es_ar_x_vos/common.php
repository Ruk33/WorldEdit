...
/** 
*
* common.php [Argentinian Spanish (Formal Honorifics)‎]
*
* @package language
* @version $Id: $
...
$lang = array_merge($lang, array(
	'TRANSLATION_INFO'	=> 'Traducción al español argentino por xirox con la colaboración de <a href="http://www.phpbb-es.com/">phpBB-Es.com</a><br />Traducción actualizada por <a href="http://www.phpbbnxg.com/">nextgen</a>',
	'DIRECTION'	=> 'ltr',
	'DATE_FORMAT'	=> '|d M Y|',
	'USER_LANG'	=> 'es-ar-x-vos',
	...
	'ACTIVE'	=> 'Activo',
	'ACTIVE_ERROR'	=> 'El usuario especificado está inactivo de momento. Si tenés problemas para activar tu cuenta por favor contactá con La Administración del Sitio.',
	...
	'AVATAR_PHP_SIZE_OVERRUN'	=> 'El tamaño del avatar es muy grande. El tamaño máximo de subida es %1$d %2$s.<br />Por favor observá que esto está definido en php.ini y no puede ser cambiado.',
	...
	'BACK_TO_TOP'	=> 'Arriba',
	'BACK_TO_PREV'	=> 'Regresá a la página anterior',
	...
	'BOARD_BAN_PERM'	=> 'Has sido expulsado <strong>permanentemente</strong> de este Sitio.<br /><br />Por favor contactá con %2$sLa Administración del Sitio%3$s para más información.',
	'BOARD_BAN_REASON'	=> 'Motivo de la exclusión: <strong>%s</strong>',
	'BOARD_BAN_TIME'	=> 'Has sido excluido de este Sitio hasta <strong>%1$s</strong>.<br /><br />Por favor contactá con %2$sLa Administración del Sitio%3$s para más información.',
	'BOARD_DISABLE'	=> 'Disculpe. Este Sitio no está disponible de momento',
	'BOARD_DISABLED'	=> 'Este Sitio está deshabilitado por ahora',
	'BOARD_UNAVAILABLE'	=> 'Disculpá. Este Sitio no está disponible por ahora, por favor intentalo de nuevo en unos minutos',
	...
	'EMPTY_SUBJECT'	=> 'Debés especificar un asunto cuando publiqués un nuevo tema.',
	...
	'LOGIN'	=> 'Identificarte',
	'LOGIN_CHECK_PM'	=> 'Autentificate para leer tus mensajes privados',
	'LOGIN_CONFIRMATION'	=> 'Confirmación de conexión',
	'LOGIN_CONFIRM_EXPLAIN'	=> 'Para prevenir el forzado de cuentas La Administración del Sitio se requiere que introduzcas un código de confirmación después de una cantidad máxima de identificaciones fallidas. El código se muestra en la imagen que deberías ver debajo. Si estás impedido visualmente o por cualquier motivo no podés leer ese código por favor contactá con %sLa Administración del Sitio%s.', //no usuado
	...
	'LOGIN_ERROR_PASSWORD'	=> 'Has especificado una contraseña incorrecta. Por favor verificá tu contraseña e intentalo de nuevo. Si continúas teniendo problemas, por favor contactá con %sLa Administración del Sitio%s.',
	'LOGIN_ERROR_PASSWORD_CONVERT'	=> 'No fue posible convertir tu contraseña cuando se actualizó el software de este Sitio. Por favor %ssolicitá nueva contraseña%s. Si sigues teniendo problemas por favor contactá con %sLa Administración del Sitio%s.',
	'LOGIN_ERROR_USERNAME'	=> 'Has especificado un nombre de usuario incorrecto. Por favor verificá tu nombre de usuario e intentalo de nuevo. Si continúas teniendo problemas, por favor contactá con %sLa Administración del Sitio%s.',
	'LOGIN_FORUM'	=> 'Para ver o publicar en este foro debés introducir la contraseña.',
	'LOGIN_INFO'	=> 'Para autenticarte debés estar registrado. Registrarte tomará solo unos pocos segundos y te permitirá un amplio acceso al sistema. La Administración del Sitio puede además otorgar permisos adicionales a los usuarios registrados. Antes de identificarte asegurate de estar familiarizado con nuestros términos de uso y políticas relacionadas. Por favor leé las reglas de los foros mientras navegás por el Sitio.',
	'LOGIN_VIEWFORUM'	=> 'La Administración del Sitio requiere que estés registrado y te hayas identificado para ver este foro.',
	'LOGIN_EXPLAIN_EDIT'	=> 'Para editar mensajes en este foro debés estar registrado e identificado.',
	'LOGIN_EXPLAIN_VIEWONLINE'	=> 'Para ver la lista en línea debés estar registrado e identificado.',
	...
	'NOTIFY_ADMIN_EMAIL'	=> 'Por favor notificá a La Administración del Sitio o webmaster: <a href="mailto:%1$s">%1$s</a>',
	...
	'NO_AUTH_ADMIN_USER_DIFFER'	=> 'No podés reidentificarte como un usuario distinto.',
	...
	'POST_BY_AUTHOR'	=> 'por',
	'POST_BY_FOE'	=> 'Este mensaje me fue enviado por <strong>%1$s</strong> quien actualmente está en tu lista de ignorados. %2$sMostrar estos mensajes%3$s.',
	...
	'REMOVE'	=> 'Eliminar',
	'REMOVE_INSTALL'	=> 'Por favor borrá, muevé o renombrá la carpeta <strong>install</strong> antes de usar tu foro. Si este directorio aún está presente solo será accesible el Panel de Administración (ACP).',
	'REPLIES'	=> 'Respuestas',
	...
	'RULES_ATTACH_CAN'	=> '<strong>Podés</strong> enviar adjuntos en este Foro',
	'RULES_ATTACH_CANNOT'	=> '<strong>No podés</strong> enviar adjuntos en este Foro',
	'RULES_DELETE_CAN'	=> '<strong>Podés</strong> borrar tus mensajes en este Foro',
	'RULES_DELETE_CANNOT'	=> '<strong>No podés</strong> borrar tus mensajes en este Foro',
	'RULES_DOWNLOAD_CAN'	=> '<strong>Podés</strong> descargar adjuntos en este Foro',
	'RULES_DOWNLOAD_CANNOT'	=> '<strong>No podés</strong> descargar adjuntos en este Foro',
	'RULES_EDIT_CAN'	=> '<strong>Podés</strong> editar tus mensajes en este Foro',
	'RULES_EDIT_CANNOT'	=> '<strong>No podés</strong> editar tus mensajes en este Foro',
	'RULES_LOCK_CAN'	=> '<strong>Podés</strong> bloquear tus temas en este Foro',
	'RULES_LOCK_CANNOT'	=> '<strong>No podés</strong> bloquear tus temas en este Foro',
	'RULES_POST_CAN'	=> '<strong>Podés</strong> abrir nuevos temas en este Foro',
	'RULES_POST_CANNOT'	=> '<strong>No podés</strong> abrir nuevos temas en este Foro',
	'RULES_REPLY_CAN'	=> '<strong>Podés</strong> responder a temas en este Foro',
	'RULES_REPLY_CANNOT'	=> '<strong>No podés</strong> responder a temas en este Foro',
	'RULES_VOTE_CAN'	=> '<strong>Podés</strong> votar en encuestas en este Foro',
	'RULES_VOTE_CANNOT'	=> '<strong>No podés</strong> votar en encuestas en este Foro',
	...
	'SQL_ERROR_OCCURRED'	=> 'Ocurrió un error SQL mientras recuperaba esta página. Por favor contactá con La Administración del Sitio%s si el problema persiste.',
	...
	'TOPIC_LOCKED'	=> 'Este tema está cerrado, no podés editar mensajes o enviar nuevas respuestas',
	...
	'USER_CANNOT_READ'	=> 'No podés leer mensajes en este Foro',
	'USER_POST'	=> '%d Mensaje',
